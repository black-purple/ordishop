<footer>
  <div id="footerTopSection" class="py-3">
    <svg id="Layer_1" data-name="Layer 1" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1920 178">
      <defs>
        <style>
          .cls-1 {
            fill: #0d1840;
      ...
      <path class="cls-1" d="M1920,515H0V337l932,46.6q28,1.39,56,0L1920,337Z" transform="translate(0 -337)" />
    </svg>
    ...
    <div class="pe-5 d-flex justify-content-between">
      ...
      <span class="dropdown">
        ...
        <ul class="dropdown-menu dropdown-menu-end">
          <li><a class="dropdown-item" data-bs-toggle="modal" data-bs-target="#signupModal">Creer un nouveau
              compte</a></li>
          <li><a class="dropdown-item" data-bs-toggle="modal" data-bs-target="#LoginModal">Se conncter a votre
              compte</a></li>
        </ul>
      </span>
    </div>
  ...
  <div id="footerBottomSection" class="p-3">
    <span class="d-flex justify-content-between align-items-center px-5">
      <span>
        <img src="<?php echo changePaths()?>/img/os-logo.webp" height="50rem" class="me-5">
      ...
      <span class="dropdown dropup">
        ...
        <ul class="dropdown-menu">
          <li><a class="dropdown-item d-flex justify-content-between" href="#">Francais <i
                class="flag flag-france"></i></a></li>
          <li><a class="dropdown-item d-flex justify-content-between" href="#">العربية <i
                class="flag flag-morocco"></i></a></li>
        </ul>
      </span>
    </span>
  </div>
